...
int main(int argc, char* argv[])
{
  ...
  do 
  {
    ...
    do {
      ...
      Hermes::Mixins::Loggable::static_info("Runge-Kutta time step on fine mesh (t = %g s, tau = %g s, stages: %d).", 
      ...
      if (ADAPTIVE_TIME_STEP_ON) 
      {
        if (rel_err_time > TIME_ERR_TOL_UPPER) 
        {
          ...
          Hermes::Mixins::Loggable::static_info("Decreasing tau from %g to %g s and restarting time step.", 
        ...
        else if (rel_err_time < TIME_ERR_TOL_LOWER) 
        {
          ...
          Hermes::Mixins::Loggable::static_info("Increasing tau from %g to %g s.", time_step, time_step * TIME_STEP_INC_RATIO);
