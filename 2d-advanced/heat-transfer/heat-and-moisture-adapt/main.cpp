...
int main(int argc, char* argv[])
{
  ...
  {
    Hermes::Mixins::Loggable::static_info("Simulation time = %g s (%d h, %d d, %d y)",
    ...
    do
    {
      ...
      Hermes::Mixins::Loggable::static_info("Projecting fine mesh solutions on coarse meshes for error estimation.");
