...
int main(int argc, char* argv[])
{
  ...
  int ndof = Space<double>::get_num_dofs(Hermes::vector<const Space<double> *>(&xvel_space, 
      &yvel_space, &p_space, &temperature_space));
  //Hermes::Mixins::Loggable::Static::Hermes::Mixins::Loggable::static_info("ndof = %d.", ndof);
  ...
  //Hermes::Mixins::Loggable::Static::Hermes::Mixins::Loggable::static_info("Setting initial conditions.");
  ...
  //Hermes::Mixins::Loggable::Static::Hermes::Mixins::Loggable::static_info("Projecting initial condition to obtain initial vector for the Newton's method.");
  ...
  //Hermes::Mixins::Loggable::Static::Hermes::Mixins::Loggable::static_info("RE = %g", reynolds_number);
  ...
  for (int ts = 1; ts <= num_time_steps; ts++)
  {
    ...
    //Hermes::Mixins::Loggable::Static::Hermes::Mixins::Loggable::static_info("---- Time step %d, time = %g:", ts, current_time);

    // Update time-dependent essential BCs.
    if (current_time <= STARTUP_TIME) 
    {
      //Hermes::Mixins::Loggable::Static::Hermes::Mixins::Loggable::static_info("Updating time-dependent essential BC.");
    ...
    //Hermes::Mixins::Loggable::Static::Hermes::Mixins::Loggable::static_info("Solving nonlinear problem:");
    bool verbose = true;
