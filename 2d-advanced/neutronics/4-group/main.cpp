...
int main(int argc, char* argv[])
{
  ...
  do
  {
    Hermes::Mixins::Loggable::static_info("------------ Power iteration %d:", it);
    
    Hermes::Mixins::Loggable::static_info("Newton's method.");
    ...
    Hermes::Mixins::Loggable::static_info("Largest eigenvalue: %.8g, rel. difference from previous it.: %g", k_new, fabs((k_eff - k_new) / k_new));
