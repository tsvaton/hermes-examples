...
{
  Hermes::Mixins::Loggable::static_info("Creating tables of constitutive functions (complicated real exponent relations).");
  ...
  Hermes::Mixins::Loggable::static_info("Calculating and saving K(h).");
  ...
  Hermes::Mixins::Loggable::static_info("Calculating and saving dKdh(h).");
  for (int j=0; j<material_count; j++) {
    for (int i=0; i< bound; i++) {
  ...
  Hermes::Mixins::Loggable::static_info("Calculating and saving C(h).");
  for (int j=0; j<material_count; j++) {
    for (int i=0; i< bound; i++) {
  ...
  if (method==1){
    ...
    Hermes::Mixins::Loggable::static_info("Calculating and saving ddKdhh(h).");
    for (int j=0; j<material_count; j++) {
      for (int i=0; i< bound; i++) {
    ...
    Hermes::Mixins::Loggable::static_info("Calculating and saving dCdh(h).");
    for (int j=0; j<material_count; j++) {
      for (int i=0; i< bound; i++) {
